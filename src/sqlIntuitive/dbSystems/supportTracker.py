...
class Features(Enum):
    ...
    # GROUPS
    SQL_ALTER_TABLE = SQL_ALTER_TABLE_ADD | SQL_ALTER_TABLE_DROP | SQL_ALTER_TABLE_MODIFY
    GROUP_SQL = SQL_CREATE_TABLE | SQL_DROP_TABLE | SQL_ALTER_TABLE | SQL_INSERT_INTO | SQL_UPDATE | SQL_DELETE_FROM | SQL_SELECT_FROM | SQL_PRIMARY_KEYS | SQL_FOREIGN_KEYS | SQL_FOREIGN_KEYS_CUSTOM_CONSTRAINT | SQL_UNIQUE | SQL_COUNT_AVG_SUM | SQL_STORED_PROCEDURES
